Created At: 2026-08-27T10:39:36+09:00
Completed At: 2026-08-27T10:39:36+09:00
File Path: `file:///d:/Project_Lab/Lab%20Database/Project/backend/parsers/xml_parser.py`
Total Lines: 267
Total Bytes: 12498
            ...
            for idx, int_node in enumerate(tool_numbers_node.findall('int'), start=1):
                ...
                if is_new_workplan:
                    step = Workingstep(
                        ...
                        tool_company=target_tool.company_name if target_tool else None,
                        tool_type=target_tool.tool_type if target_tool else None,
                        tool_diameter=target_tool.cutter_diameter if target_tool else None,
                        tool_spec=target_tool.specification if target_tool else None,
                        tool_teeth=target_tool.tool_teeth if target_tool else None
                    )
                    db.add(step)
